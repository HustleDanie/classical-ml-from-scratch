...
def main():
    ...
    for eps in eps_values:
        ...
        print(f"  ε={eps:.1f}: {nc} clusters, {nn} noise")
    ...
    plot_dbscan_vs_kmeans(X_moon_s, y_moon, eps=0.3, min_samples=5, k=2,
    ...
    plot_dbscan_vs_kmeans(X_circ_s, y_circ, eps=0.3, min_samples=5, k=2,
    ...
    plot_dbscan_vs_kmeans(X_spiral_s, y_spiral, eps=0.25, min_samples=5, k=2,
    ...
    3.  EPS (ε) PARAMETER        — Neighborhood radius controls cluster scale
    4.  MIN_SAMPLES PARAMETER    — Density threshold for core points
    5.  k-DISTANCE GRAPH         — Visual method for choosing ε
    ...
    9.  VARYING DENSITY PROBLEM  — Single ε fails for mixed-density data
    10. DETERMINISTIC RESULTS    — Core points always assigned consistently
    11. PARAMETER SENSITIVITY    — Small ε changes → big clustering changes
