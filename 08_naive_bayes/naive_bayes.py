...
def main():
    ...
    for a in alphas:
        ...
        print(f"  α={a:6.3f}: Train={tr_acc:.4f}, Test={te_acc:.4f}")
    ...
    3.  GAUSSIAN NB             — Continuous features modeled by N(μ, σ²)
    ...
    7.  LAPLACE SMOOTHING       — Prevents zero-probability issues (α parameter)
