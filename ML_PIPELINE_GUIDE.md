...
> See [FEATURE_SELECTION_GUIDE.md](FEATURE_SELECTION_GUIDE.md) for detailed methods, thresholds, and 20 real-world scenarios.
...
> See [MODEL_SELECTION_GUIDE.md](MODEL_SELECTION_GUIDE.md) for detailed model comparison tables and 15 case studies.
...
- [PROBLEM_TYPES_GUIDE.md](PROBLEM_TYPES_GUIDE.md) — Which problem type are you solving?
- [MODEL_SELECTION_GUIDE.md](MODEL_SELECTION_GUIDE.md) — Which model to pick and why?
- [FEATURE_SELECTION_GUIDE.md](FEATURE_SELECTION_GUIDE.md) — How to select and evaluate features?
